...
- 스크립트: [`scripts/create-company-frontend.mjs`](./scripts/create-company-frontend.mjs)
- 설치 스크립트: [`install/install-create-company-frontend.sh`](./install/install-create-company-frontend.sh)
- 스킬: [`skills/create-company-frontend`](./skills/create-company-frontend/SKILL.md)
- 문서: [`docs/create-company-frontend.md`](./docs/create-company-frontend.md)
...
- 스크립트: [`scripts/weekly-report.sh`](./scripts/weekly-report.sh)
- 설치 스크립트: [`install/install-weekly-report.sh`](./install/install-weekly-report.sh)
- 스킬: [`skills/weekly-report`](./skills/weekly-report/SKILL.md)
- 문서: [`docs/weekly-report.md`](./docs/weekly-report.md)
